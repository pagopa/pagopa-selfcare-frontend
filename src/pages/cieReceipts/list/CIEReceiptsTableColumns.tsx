    ...
    return [
        {
            ...
            headerName: t('cieReceiptsPage.column.iuv'),
            align: 'left',
            headerAlign: 'left',
            minWidth: 400,
            editable: false,
        ...
        },
        {
            ...
            headerName: t('cieReceiptsPage.column.taxCode'),
            align: 'left',
            headerAlign: 'left',
            minWidth: 300,
            editable: false,
        ...
        },
        {
            ...
            cellClassName: 'justifyContentNormal',
            headerName: t('cieReceiptsPage.column.paymentDate'),
            align: 'left',
            headerAlign: 'left',
            editable: false,
            disableColumnMenu: true,
        ...
        },
        {
            ...
            getActions: (params: any) => [
                <Box key={`DownloadReceipts-${params.row.iuv}`} pr={1}>
                    ...
                    >
                        {t('cieReceiptsPage.column.downloadButton')}
                    </Button>
                </Box>,
            ],
            sortable: false,
