...
import CommissionBundleOffersTable from '../CommissionBundleOffersTable';
...
describe('<CommissionBundleOffersTable />', () => {
  afterEach(() => {
    jest.clearAllMocks();
  });

  test('render component CommissionBundleOffersTable and test empty table, change state filter & render datagrid', async () => {
  ...
  test('render component CommissionBundleOffersTable and test error retrieving request detail', async () => {
  ...
  test('render component CommissionBundleOffersTable and test delete accepted subscriptions', async () => {
    spyOnGetPublicBundleCISubscriptions.mockReturnValue(Promise.resolve(mockedCiSubscriptionList));
    render(
      <Provider store={store}>
        <MemoryRouter initialEntries={[`/comm-bundles/${idBundle}/`]}>
  ...
  test('render component CommissionBundleOffersTable and test reject waiting requests', async () => {
    spyOnGetPublicBundleCISubscriptions.mockReturnValue(Promise.resolve(mockedCiSubscriptionList));
    render(
      <Provider store={store}>
        <MemoryRouter initialEntries={[`/comm-bundles/${idBundle}/`]}>
  ...
  test('render component CommissionBundleOffersTable and test accept waiting requests', async () => {
    spyOnGetPublicBundleCISubscriptions.mockReturnValue(Promise.resolve(mockedCiSubscriptionList));
    render(
      <Provider store={store}>
        <MemoryRouter initialEntries={[`/comm-bundles/${idBundle}/`]}>
  ...
  test('render component CommissionBundleOffersTable and test error action on waiting requests', async () => {
    spyOnGetPublicBundleCISubscriptions.mockReturnValue(Promise.resolve(mockedCiSubscriptionList));
    render(
      <Provider store={store}>
        <MemoryRouter initialEntries={[`/comm-bundles/${idBundle}/`]}>
  ...
  test('render component CommissionBundleOffersTable and test error on retrieve subscription list', async () => {
