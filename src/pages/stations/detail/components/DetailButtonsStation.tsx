...
import { ContentCopy, Delete, MiscellaneousServices, ModeEdit } from '@mui/icons-material';
...
const DetailButtonsStation = ({ stationDetail, setStationDetail }: Props) => {
  ...
  const disableOnPendingUpdate =
    stationDetail?.wrapperStatus === WrapperStatusEnum.APPROVED && stationDetail?.pendingUpdate;
