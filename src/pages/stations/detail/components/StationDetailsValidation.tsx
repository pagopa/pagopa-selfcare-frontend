                        ...
                        <Grid container spacing={2}>
                            <Grid container item alignContent="center" spacing={2} pb={4}>
                                ...
                                <Grid item xs={12} mt={2}>
                                    <Typography
                                        variant="sidenav">{t('stationDetailPageValidation.endpoints.modello1')}</Typography>
                                </Grid>
                                <Grid item xs={3}>
                                    <Typography
                                        variant="body2">{t('stationDetailPageValidation.endpoints.endpointRTConcat')}</Typography>
                                </Grid>
                                <Grid item xs={9}>
                                    <Typography variant="body2" fontWeight={'fontWeightMedium'}>
                                ...
                                <Grid item xs={3}>
                                    <Typography
                                        variant="body2">{t('stationDetailPageValidation.endpoints.endpointRedirectConcat')}</Typography>
                                </Grid>
                                <Grid item xs={9}>
                                    <Typography variant="body2" fontWeight={'fontWeightMedium'}>
                                ...
                                <Grid item xs={12} mt={2}>
                                    <Typography
                                        variant="sidenav">{t('stationDetailPageValidation.endpoints.modelloUnico')}</Typography>
                                </Grid>
                                <Grid item xs={3}>
                                    <Typography
                                        variant="body2">{t('stationDetailPageValidation.endpoints.endpointMUConcat')}</Typography>
                                </Grid>
                                <Grid item xs={9}>
                                    <Typography variant="body2" fontWeight={'fontWeightMedium'}>
                                ...
                                <Grid item xs={3}>
                                    <Typography
                                        variant="body2">{t('stationDetailPageValidation.endpoints.primitiveVersion')}</Typography>
                                </Grid>
                                <Grid item xs={9}>
                                    <Typography variant="body2" fontWeight={'fontWeightMedium'}>
