...
function CustomStationSearchBar(props: GridToolbarQuickFilterProps) {
  const {
  ...
  return (
    <Grid sx={{ display: 'flex', flexDirection: 'row' }} mt={3}>
      ...
      >
        <Typography mx={3} sx={{ color: 'background.paper', fontWeight: '600', fontSize: '16px' }}>
...
CustomStationSearchBar.propTypes = {
  // ----------------------------- Warning --------------------------------
