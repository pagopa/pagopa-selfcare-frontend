...
// import {institutionDetailResource2Party, Party,} from '../../model/Party';
//
// import {BackofficeApi, mockedInstitutionDetailResource} from '../../api/__mocks__/BackofficeClient';
// import {Institution, Institution_typeEnum,} from '../../api/generated/portal/Institution';
//
...
// });
//
// export const pspAdminSignedInstitution: Institution = {
...
//     mail_address: 'pspAdminSigned@test.dummy',
//     status: 'ACTIVE',
...
// };
//
// export const pspAdminUnsignedInstitution: Institution = {
//     id: 'pspAdminSignedUndirect',
//     externalId: 'pspAdminSignedUndirect',
//     originId: 'PSP_pspAdminSignedUndirect',
//     origin: 'SELC',
//     institutionType: 'PSP' as Institution_typeEnum,
...
// };
//
// export const ecAdminSignedInstitution: Institution = {
//     id: 'ecAdminSignedDirect',
//     externalId: '1122334455',
//     originId: 'c_g922',
//     origin: 'IPA',
//     institutionType: 'PA' as Institution_typeEnum,
...
// };
//
// export const pspOperatorUnsignedInstitution: Institution = {
...
// };
//
// export const ecOperatorUnsignedInstitution: Institution = {
...
// };
//
// export const mockedInstitutions: Array<Institution> = [
...
//     expect(parties[0]).toMatchObject(mockedInstitutions.map(Institution2Party)[0]);
//     expect(parties[1]).toMatchObject(mockedInstitutions.map(Institution2Party)[1]);
//     expect(parties[6]).toMatchObject(mockedInstitutions.map(Institution2Party)[3]);
//
//     parties.forEach((p) =>
...
//         const parties = mockedInstitutions.map(Institution2Party);
