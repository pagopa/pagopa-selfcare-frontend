...
export const LOADING_TASK_DISSOCIATE_EC_STATION = 'DISSOCIATE_EC_STATION';
...
export const LOADING_TASK_QUICKSIGHT_DASHBOARD = "QUICKSIGHT_DASHBOARD";
export const INSTITUTIONS_PSP_TYPES = ['PSP'];
export const INSTITUTIONS_EC_TYPES = ['PA', 'GSP', 'SCP', 'PG', 'GPU', 'PRV'];
